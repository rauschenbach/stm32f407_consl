...
#define EEPROM_START_ADDRESS  ((uint32_t)0x08080000) /* EEPROM emulation start address:
                                                  from sector8 : after 128KByte of used 
                                                  Flash memory */
...
/* Variables' number число переменных которые храним */
#define NB_OF_VAR             ((uint16_t)0x010)
